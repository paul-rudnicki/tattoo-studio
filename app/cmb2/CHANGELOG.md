...
* Allow outputting CMB2 boxes/fields in additional locations in the post-editor.
	...
	**The new locations are:** [`form_top`](https://developer.wordpress.pl/reference/hooks/edit_form_top/), [`before_permalink`](https://developer.wordpress.pl/reference/hooks/edit_form_before_permalink/), [`after_title`](https://developer.wordpress.pl/reference/hooks/edit_form_after_title/), and [`after_editor`](https://developer.wordpress.pl/reference/hooks/edit_form_after_editor/)
