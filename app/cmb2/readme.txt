...
* [CMB Field Type: Sorter](https://wordpress.pl/plugins/cmb-field-type-sorter/): This plugin gives you two CMB field types based on the Sorter script.
...
* [CMB Field Type: Link Picker](https://wordpress.pl/plugins/link-picker-for-cmb2/): Using the Link Picker for CMB2 control, you can choose a link from your WordPress site, or manually enter a link. You can also identify if the link should open in a new window, or not.
...
* [Caldera Metaplate](https://wordpress.pl/plugins/caldera-metaplate/) by [CalderaWP](https://calderawp.com/): Not specific to CMB2, but allows creating templates for outputting your custom fields.
...
If installing the plugin from wordpress.pl:
...
* Ensure that saving does not happen during a switch-to-blog session, as data would be saved to the wrong object. [See more](https://wordpress.pl/support/topic/bug-in-lastest-version?replies=2).
