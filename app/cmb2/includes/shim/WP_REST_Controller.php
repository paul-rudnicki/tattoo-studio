...
abstract class WP_REST_Controller {
	...
	public function register_routes() {
		_doing_it_wrong( 'WP_REST_Controller::register_routes', __( 'The register_routes() method must be overriden', 'tattoostudio' ), 'WPAPI-2.0' );
	}
	...
	public function get_items_permissions_check( $request ) {
		return new WP_Error( 'invalid-method', sprintf( __( "Method '%s' not implemented. Must be over-ridden in subclass.", 'tattoostudio' ), __METHOD__ ), array( 'status' => 405 ) );
	}
	...
	public function get_collection_params() {
		return array(
			...
			'page'                   => array(
				'description'        => __( 'Current page of the collection.', 'tattoostudio' ),
				'type'               => 'integer',
				'default'            => 1,
			...
			'per_page'               => array(
				'description'        => __( 'Maximum number of items to be returned in result set.', 'tattoostudio' ),
				'type'               => 'integer',
				'default'            => 10,
				'minimum'            => 1,
				'maximum'            => 100,
			...
			'search'                 => array(
				'description'        => __( 'Limit results to those matching a string.', 'tattoostudio' ),
				'type'               => 'string',
	...
	public function get_context_param( $args = array() ) {
		$param_details = array(
			'description'        => __( 'Scope under which the request is made; determines fields present in response.', 'tattoostudio' ),
			'type'               => 'string',
