...
class CMB2_Type_File extends CMB2_Type_File_Base {
	...
	public function render() {
		...
		$output .= sprintf( '<input class="cmb2-upload-button button" type="button" value="%s" />', esc_attr( $this->_text( 'add_upload_file_text', esc_html__( 'Add or Upload File', 'tattoostudio' ) ) ) );
