...
vc_map(array(
    ...
    'params' => array(
        ...
        array(
            'type' => 'number',
            'admin_label' => true,
            'heading' => esc_html__('Counter value', 'tattoostudio'),
        ...
        array(
            'type' => 'textfield',
            'heading' => esc_html__('Counter title', 'tattoostudio'),
        ...
        array(
            'type' => 'textfield',
            'heading' => esc_html__('Extra class name', 'tattoostudio'),
            'param_name' => 'custom_class',
            'description' => esc_html__('Style particular content element differently - add a class name and refer to it in custom CSS.', 'tattoostudio'),
        ),
        array(
            'type' => 'css_editor',
